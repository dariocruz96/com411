...
if path=="dragon":
    print("Oh no, the dragon seems to be bigger than a mountain and your friend dies while saving you from certain death!")
    print("Your current status are: ")
    print("Lives:  " + "\u2764" * 3)
    print("Energy: " + "\u2742" * 1)
    print("Shield: " + "\u2756" * 0)
...
if secondPath =="try again":
    ...
    print("You were able to run away, but...what a disgrace you are to your people...Enjoy the rest of your life, you scary fish!")